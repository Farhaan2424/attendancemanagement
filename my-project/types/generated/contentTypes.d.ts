...
export interface ApiAttendanceAttendance extends Schema.CollectionType {
  ...
  attributes: {
    checkIn: Attribute.Time;
    checkOut: Attribute.Time;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    status: Attribute.Enumeration<['present', 'absent', 'late', 'leave']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::attendance.attendance',
      'oneToOne',
...
export interface ApiEmployeeEmployee extends Schema.CollectionType {
  ...
  attributes: {
    ...
    accountType: Attribute.Enumeration<['savings', 'current']>;
    ...
    basic_percentage: Attribute.Decimal;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::employee.employee',
      'oneToOne',
    ...
    differentlyAbled: Attribute.String;
    dob: Attribute.Date;
    email: Attribute.Email;
    Employee: Attribute.Relation<
      'api::employee.employee',
    ...
    >;
    employeeid: Attribute.UID & Attribute.Required;
    fathersName: Attribute.String;
    fixed_allowance: Attribute.Integer;
    gender: Attribute.String;
    hra_percentage: Attribute.Decimal;
    ifsc: Attribute.String;
    joinDate: Attribute.Date;
    medical_allowance: Attribute.Integer;
    monthly_ctc: Attribute.Integer;
    name: Attribute.String;
    officeLocation: Attribute.String;
    pan: Attribute.String;
    paymentMode: Attribute.String;
    personalEmail: Attribute.Email;
    phone: Attribute.String;
    position: Attribute.String;
    publishedAt: Attribute.DateTime;
    residentialAddress: Attribute.Text;
    role: Attribute.Enumeration<['HR', 'Employee', 'Admin', 'Manager']>;
    status: Attribute.Enumeration<['active', 'inactive']>;
    transport_allowance: Attribute.Integer;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::employee.employee',
      'oneToOne',
...
export interface ApiJustificationJustification extends Schema.CollectionType {
  ...
  attributes: {
    attendance: Attribute.Relation<
      'api::justification.justification',
      'oneToOne',
      'api::attendance.attendance'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiLeaveRequestLeaveRequest extends Schema.CollectionType {
...
export interface ApiPayrollPayroll extends Schema.CollectionType {
  ...
  attributes: {
    absent_days: Attribute.Integer;
    basic: Attribute.Integer;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::payroll.payroll',
      'oneToOne',
    ...
    >;
    fixed_allowance: Attribute.Integer;
    generated_at: Attribute.DateTime;
    gross_salary: Attribute.Integer;
    hra: Attribute.Integer;
    medical_allowance: Attribute.Integer;
    month: Attribute.String;
    net_salary: Attribute.Integer;
    present_days: Attribute.Integer;
    publishedAt: Attribute.DateTime;
    status: Attribute.Enumeration<['Pending', 'Generated', 'Paid']>;
    transport_allowance: Attribute.Integer;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::payroll.payroll',
    ...
    > &
      Attribute.Private;
    working_days: Attribute.Integer;
